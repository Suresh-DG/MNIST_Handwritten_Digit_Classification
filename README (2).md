...
A simple feedforward neural network (TensorFlow/Keras) that classifies handwritten digits (0–9) from the MNIST dataset — built as part of a Deep Learning assignment.
...
| File | Description |
|---|---|
| `MNIST_Assignment_Updated.ipynb` | Main Jupyter Notebook — full code, outputs, and plots |
| `report.pdf` | 2–3 page handwritten report (Introduction, Theory, Model, Results, Experiment, Conclusion) |
...
**USN:** _______________
**Course:** B.Tech Information Technology (AI & ML), Rai Technology University
